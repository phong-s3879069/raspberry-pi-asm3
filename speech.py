...
onCommand = ["turn on", "on", "turn on the light", "turn on the lights", "on the light", "hello"]
offCommand = ["turn off", "off", "turn off the light", "turn off the lights", "off the light", "bye"]
        ...
        try: 
            with mic as source:
                    ...
                    if (response in onCommand):
                        ...
                        print("Pi: Have you set the timer?")
                    ...
                    if (response not in onCommand and response not in offCommand and response != ""):
                        count += 1
                        print(count)
                        if (count == 3):
                    ...
                    # Check if the user would like to end the program
